 ...
 * {@link UserIdentity}. Nodes and engines start by reading a certificate, which establishes the
 ...
 * as a {@link Engine}, then duplicate the {@link UserIdentity} as the default
 * {@link IEngineUserIdentity}, to which they can add others if local authentication is enabled.
 * {@link ISession Sessions} are appended to each IEngineUser, {@link Observation observations} to
...
public abstract interface Identity {
     ...
     *
     * @param type a {@link org.integratedmodelling.klab.api.Identity.IIdentity.Type} object.
     * @return a boolean.
     */
