...
public class Settings {
    ...
    public Settings(Release release) {
        ...
        workspaceDirectory.setValue(new File(System.getProperty("user.home") + File.separator + ".klab" + File.separator + "workspace"));
        exportDirectory.setValue(new File(System.getProperty("user.home") + File.separator + ".klab" + File.separator + "export"));
        certificateFile.setValue(new File(System.getProperty("user.home") + File.separator + ".klab" + File.separator + "klab.cert"));
        tempDirectory.setValue(new File(Configuration.INSTANCE.getProperty(Configuration.KLAB_TEMPORARY_DATA_DIRECTORY, System.getProperty("java.io.tmpdir"))));
        releaseDirectory.setValue(new File(System.getProperty("user.home") + File.separator + ".klab" + File.separator + "releases"));
    ...
    //        } else {
    //            throw new IllegalArgumentException("Unknown release policy option: " + releasePolicy);
    //        }
    //
    //    }
