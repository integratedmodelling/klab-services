...
//	}
	...
	/** {@inheritDoc} */
	@Override
	public Resource.Builder addError(Object... o) {
//		notifications.add(Notification.of(o, Level.SEVERE));
		errors = true;
		return this;
	}
	...
	/** {@inheritDoc} */
	@Override
	public Resource.Builder addWarning(Object... o) {
//		notifications.add(new KimNotification(NotificationUtils.getMessage(o), Level.WARNING));
	...
	/** {@inheritDoc} */
	@Override
	public Resource.Builder addInfo(Object... o) {
...
//	@Override
//	public Resource.Builder withCategorizable(String id) {
