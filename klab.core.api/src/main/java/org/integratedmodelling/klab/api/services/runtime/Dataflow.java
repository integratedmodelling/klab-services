...
public interface Dataflow<T extends Artifact> extends Serializable {
    ...
    // * and complex extents makes the code unsuitable for transmission to clients, the runtime
    // should
    ...
    /**
     * The total coverage of this dataflow, resulting from intersecting the coverage of all the
     * actuators it contains.
     * 
     * @return
     */
