...
public interface KimConcept extends KimStatement, Knowledge {
    ...
    /**
     * Distributed inherency is when either the inherent or the context are specified as distributed
     * with an <code>each</code> keyword. This matters for attribute observations as it
     * discriminates between resolvers and classifiers. The role returned should be either null,
     * CONTEXT or INHERENT; when not null, the corresponding concepts must be directly specified..
     * 
     * @return
     */
