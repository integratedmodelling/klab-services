 ...
 * produce implementation classes that depend on complex dependencies.
 * Implements a poor-man injection pattern that needs to be configured in a
 * static block. This permits complex classes like Scale or Projection to have
 * generic builders declared in the API package.
 * 
 * @author Ferd
 *
 */
