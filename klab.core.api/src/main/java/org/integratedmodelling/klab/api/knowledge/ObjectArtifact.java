 ...
 *
 * <p>TODO unused at the moment. Revise and incorporate the logic into the modern API.
 *
 * @author Ferd
 * @version $Id: $Id
 */
public interface ObjectArtifact extends Artifact {
   ...
   *
   * @param cls class or interface for children. Pass IObservation.class for everything.
   * @return a collection of all the children of the requested class.
   */
  <T extends Artifact> Collection<T> getChildren(Class<T> cls);
}
