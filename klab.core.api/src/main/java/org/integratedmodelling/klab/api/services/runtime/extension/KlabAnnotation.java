...
/**
 * This annotation can be used along with a dummy class or one that extends Annotation to declare an
 * annotation without needing to provide a k.DL prototype for it. It's a stripped-down version of
 * {@link KlabFunction} and uses the same {@link Argument} class to declare arguments.
 * 
 * @author Ferd
 *
 */
...
public @interface KlabAnnotation {
    ...
    /**
     * The targets this annotation can annotate. Nothing = usable everywhere.
     * 
     * @return
     */
    KnowledgeClass[] targets() default {};
}
