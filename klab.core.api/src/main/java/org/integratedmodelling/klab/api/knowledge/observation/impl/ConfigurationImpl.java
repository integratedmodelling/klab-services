...
public class ConfigurationImpl extends DirectObservationImpl implements Configuration {
    public ConfigurationImpl() {
    }

    public ConfigurationImpl(Observable observable, String id, ContextScope scope) {
