 ...
 * {@link Prototype#getGeometry() service prototype} declared in KDL). When used in such a
...
public interface Geometry extends Serializable, Locator {
    ...
    public interface Dimension extends Serializable {
         ...
         * {@link Geometry#UNDEFINED}, which is a negative value.
         * 
         ...
         * {@link Geometry#UNDEFINED} values of size corresponding to the dimensionality.
         * 
         * @param dimension
...
//    Geometry getChild();
     ...
     * <p>
     * Locators can be converted to the desired form using {@link Locator#as(Class)}. So if numeric
