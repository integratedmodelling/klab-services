...
/**
 * Interface for those extension action classes that are declared by tagging classes
 * with {@link Action} within Java-specified behaviors.
 * 
 * @author Ferd
 *
 */
...
//		 * @param scope
//		 */
//		void onMessage(KlabMessage message, KActorScope scope);
