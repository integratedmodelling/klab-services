...
public final class ProposalEnums {
  ...
  public enum Disposition {
    ...
    @JsonProperty("defer")
    DEFER,
    @JsonProperty("not_a_worldview_concept")
    NOT_A_WORLDVIEW_CONCEPT
  }
  ...
  public enum ObservableKind {
    ...
    @JsonProperty("charge")
    CHARGE,
    @JsonProperty("electric-potential")
    ELECTRIC_POTENTIAL,
    @JsonProperty("energy")
    ENERGY,
  ...
  public enum SemanticFlag {
    ...
    STRUCTURAL,
    @JsonProperty("deniable")
    DENIABLE,
    @JsonProperty("rescaling")
    RESCALING
  }
  ...
  public enum Perspective {
    ...
    @JsonProperty("functional")
    FUNCTIONAL,
    @JsonProperty("cross_perspective")
    CROSS_PERSPECTIVE,
  ...
  public enum AggregationBehavior {
    @JsonProperty("extensive")
    EXTENSIVE,
    @JsonProperty("intensive")
    INTENSIVE,
    @JsonProperty("not_applicable")
    NOT_APPLICABLE,
  ...
  public enum OrthogonalityRelationType {
    ...
    COMPOSITIONAL,
    @JsonProperty("partially_overlapping")
  ...
  public enum DiscourseUse {
    ...
    MODEL_DEFINITION,
    @JsonProperty("community_governance")
    COMMUNITY_GOVERNANCE
  }

  public enum CompositionOutcome {
    @JsonProperty("keep_expression")
    KEEP_EXPRESSION,
    @JsonProperty("alias_with_equals")
    ALIAS_WITH_EQUALS,
    @JsonProperty("specialize_with_is")
    SPECIALIZE_WITH_IS,
    @JsonProperty("unresolved")
    UNRESOLVED
  }
  ...
  public enum AlignmentAction {
    @JsonProperty("implicit_type_only")
    IMPLICIT_TYPE_ONLY,
    @JsonProperty("reuse_exact")
    REUSE_EXACT,
    @JsonProperty("specialize")
    SPECIALIZE,
    @JsonProperty("authority_reference")
    AUTHORITY_REFERENCE,
    @JsonProperty("new_root_candidate")
    NEW_ROOT_CANDIDATE,
    @JsonProperty("unresolved")
    UNRESOLVED
  }
  ...
  public enum AncestryStatus {
    ...
    VERIFIED,
    @JsonProperty("missing_parent")
    MISSING_PARENT,
    @JsonProperty("missing_tier_1_ancestor")
    MISSING_TIER_1_ANCESTOR,
    @JsonProperty("unresolved")
    UNRESOLVED,
    @JsonProperty("not_applicable")
    NOT_APPLICABLE
  ...
  public enum SyntaxStatus {
    ...
    NOT_ATTEMPTED,
    @JsonProperty("illustrative")
    ILLUSTRATIVE,
    @JsonProperty("parsed")
    PARSED,
    @JsonProperty("adapted")
    ADAPTED,
    @JsonProperty("reasoner_validated")
    REASONER_VALIDATED
  }
  ...
  public enum OntologyRole {
    ...
    @JsonProperty("upper")
    UPPER,
    @JsonProperty("tier_1_mandatory")
    TIER_1_MANDATORY,
    @JsonProperty("intervening_tier")
    INTERVENING_TIER,
    @JsonProperty("neighboring")
    NEIGHBORING,
    @JsonProperty("authority")
    AUTHORITY,
    @JsonProperty("prior_domain")
    PRIOR_DOMAIN
  }
  ...
  public enum GapStatus {
    ...
    SUPPLIED,
    @JsonProperty("resolved_upstream")
    RESOLVED_UPSTREAM,
    @JsonProperty("resolved_in_root")
    RESOLVED_IN_ROOT,
    @JsonProperty("rejected")
    REJECTED,
    @JsonProperty("superseded")
  ...
  public enum IterationState {
    @JsonProperty("open_for_feedback")
    OPEN_FOR_FEEDBACK,
    @JsonProperty("actions_proposed")
    ACTIONS_PROPOSED,
    @JsonProperty("approved_for_apply")
    APPROVED_FOR_APPLY,
    @JsonProperty("applied")
    APPLIED,
    @JsonProperty("closed")
