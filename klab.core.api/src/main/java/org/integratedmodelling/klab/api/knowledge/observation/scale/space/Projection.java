...
public interface Projection {
  ...
  /**
   * If true, the projection uses the first coordinate for the S->N direction and the second for the
   * W->E. This applies to the default lat-lon projection unless it was forced into sanity.
   *
  ...
  static Projection of(String string) {
