...
public interface Report {
  ...
  /**
   * Roles and titles of main sections, also providing the ordering for the default report template.
   *
   ...
   * references. Each may have structured content (accessible through the {@link Parameters} API)
  ...
  interface Section {
    ...
    /**
     * One of the report section roles or null. Root-level sections originating from documentation
     * must have this set.
     *
     * @return
     */
