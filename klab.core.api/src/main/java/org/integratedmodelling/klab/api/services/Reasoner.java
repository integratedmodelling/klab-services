...
public interface Reasoner extends KlabService {
    ...
    /**
     * Extract any component concept from the concept definition that matches all the semantic types
     * passed. For example, pass {@link SemanticType#ABSTRACT} and {@link SemanticType#PREDICATE} to
     * obtain all the abstract predicates involved in the concept definition.
     * 
     * @param concept
     * @return
     */
    ...
    /**
     * True if the candidate resolves the first observable, i.e. a candidate's description (model)
     * can make an observation of it.
     * 
     * @param toResolve
     * @param candidate
