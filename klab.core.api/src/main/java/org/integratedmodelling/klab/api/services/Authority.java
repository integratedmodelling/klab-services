...
public interface Authority extends Service {
    ...
    interface Identity {
        ...
        /**
         * The name of the authority, which must be capable of resolving any parents as well. The
         * first term will be used to name the ontology.
         * 
         * @return
         */
        ...
        /**
         * If not null, this will be the label for the concept that provides a parent for the
         * identity. The authority must return an identity for it. It will be declared as the base
         * identity. If null, a base identity will be created from the ontology ID and shared by all
         * identities in the authority.
         * 
         * @return
         */
        ...
        /**
         * This may be given to define which property should constrain the parents (in order). If
         * empty and parents are given, they will be superclasses.
         * 
         * @return
         */
        ...
        /**
         * Any notifications from the authority. If any of these has level = error, no concepts must
         * be created.
         * 
         * @return
         */
    ...
    interface Capabilities {
         ...
         * with their description. For now the rest of the capabilities must apply unaltered to
         ...
         * generating given a valid identifier. If not empty, the client will set up the interface
         * for documenting stated or retrieved identities and send requests accordingly.
         * 
         * @return
         */
        ...
        /**
         * If not null, the authority won't be loaded unless the certificate commits the engine or
         * node to the returned worldview.
         * 
         * @return
         */
        String getWorldview();
     ...
     * called in {@link #getIdentity(String)}. Remaining fields should be set so as to support the
