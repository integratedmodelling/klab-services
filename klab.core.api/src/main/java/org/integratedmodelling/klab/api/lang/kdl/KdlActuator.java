...
public interface KdlActuator extends KdlStatement {
	 ...
	 * this step, if any. Alternative to {@link KdlActuator#getNewObservationUrn()}
	 ...
	 * any. Alternative to {@link KdlActuator#getNewObservationType()} - if one is
	 ...
	 */
	Collection<KdlComputation> getComputations();
	 ...
	 */
	Collection<KdlActuator> getInputs();
	 ...
	 * @return the input actuators
	 */
	Collection<KdlActuator> getOutputs();
	 ...
	 */
	Collection<KdlActuator> getParameters();
	 ...
	 * @return the coverage
	 */
	List<KdlContextualizer> getCoverage();
