...
//
///**
// * {@link Product} bean which implements all the properties and can be initialized from a {@link
// * java.util.Properties} object. Subclasses will need to define any further properties.
// */
...
//  protected Status status = Status.UNAVAILABLE;
//
//  public ProductImpl() {
//    super(null);
//  }
//
//  public ProductImpl(File propertiesFile, AbstractDistributionObsoleteImpl distribution) {
...
//      File releasePropertyFile =
//          new File(
//              propertiesFile.getParent()
//                  + File.separator
//                  + releaseName
//                  + File.separator
//                  + ReleaseImpl.RELEASE_PROPERTIES_FILE);
//      // TODO update status
