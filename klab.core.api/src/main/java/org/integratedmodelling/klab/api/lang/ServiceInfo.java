...
public interface ServiceInfo extends Serializable {
   ...
   * as parameters, but they are expected to be in the context (according to their optional status)
   * of the service specified by the call.
   *
   ...
   * as parameters, but they are expected to be produced into the context (according to their
   * optional status) by the service specified by the call.
   *
