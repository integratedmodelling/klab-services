...
public interface ServiceInfo extends Serializable {
    ...
    /**
     * Observations needed by a contextualizer, matched to the context by the name in the dependency observables.
     *
    ...
    /**
     * Additional observations contextualized by the function, created before the call only if they are referenced
     * in the dataflow. Matched by name in the output observables.
     *
     ...
     * <p>
     * TODO revise, should be matched to a list of scanners for the observations tagged
     *
     ...
     * <p>
     * TODO revise, should be matched to a list of scanners for the observations tagged. Maybe remove.
     *
