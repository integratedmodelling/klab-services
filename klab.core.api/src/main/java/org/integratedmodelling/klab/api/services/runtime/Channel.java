...
public interface Channel {
     ...
     *        {@link Message} or the necessary info to build one, including a {@link MessageClass}
     *        and {@IMessage.Type} along with any payload (any serializable object). Sending a
     *        {@link Notification} should automatically promote it to a suitable logging message.
     */
