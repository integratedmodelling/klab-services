...
public interface RuntimeService extends KlabService {
	...
	/**
	 * All services publish capabilities and have a call to obtain them. Must list
	 * all the available contextualizers and verbs, with associated costs, so that
	 * they can be checked before sending a dataflow.
	 * 
	 * @author Ferd
	 *
	 */
	...
	interface Admin {
		 ...
		 * responding.
		 * 
		 * @param scope          if service scope, send all; otherwise send those
