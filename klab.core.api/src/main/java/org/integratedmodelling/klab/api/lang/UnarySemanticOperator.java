...
public enum UnarySemanticOperator {
    ...
    PRESENCE(new SemanticType[]{SemanticType.COUNTABLE}, SemanticType.QUALITY, "presence of"), // FIXME
    // does not account for the different operands
    PROPORTION(new SemanticType[]{SemanticType.TRAIT, SemanticType.QUANTIFIABLE}, SemanticType.QUALITY,
            "proportion of", "in"), PERCENTAGE(new SemanticType[]{SemanticType.TRAIT,
                                                                  SemanticType.QUANTIFIABLE},
            SemanticType.QUALITY, "percentage of", "in"),
    ...
    UNCERTAINTY(new SemanticType[]{SemanticType.QUALITY}, SemanticType.QUALITY, "uncertainty of"),
    COUNT(new SemanticType[]{SemanticType.COUNTABLE}, SemanticType.QUALITY, "count of"),
    VALUE(new SemanticType[]{SemanticType.OBSERVABLE, SemanticType.CONFIGURATION}, SemanticType.QUALITY,
            "value of", "over"), MONETARY_VALUE(new SemanticType[]{SemanticType.OBSERVABLE,
                                                                   SemanticType.CONFIGURATION},
            SemanticType.QUALITY, "monetary value of"),
    OCCURRENCE(new SemanticType[]{SemanticType.COUNTABLE}, SemanticType.QUALITY, "occurrence of"),
    CHANGE(new SemanticType[]{SemanticType.QUALITY}, SemanticType.PROCESS, "change in"),
    CHANGED(new SemanticType[]{SemanticType.QUALITY}, SemanticType.EVENT, "changed"),
    RATE(new SemanticType[]{SemanticType.QUALITY}, SemanticType.QUALITY, "change rate of"),
    MAGNITUDE(new SemanticType[]{SemanticType.QUANTIFIABLE}, SemanticType.QUALITY, "magnitude of"),
    LEVEL(new SemanticType[]{SemanticType.QUANTIFIABLE}, SemanticType.CLASS, "level of"),
    ...
    public static Set<SemanticType> getType(String string, Collection<SemanticType> original) {
        ...
        switch (id) {
            case "thing":
                return EnumSet.of(SemanticType.SUBJECT, SemanticType.DIRECT_OBSERVABLE,
            ...
            case "level":
                return EnumSet.of(SemanticType.CLASS, SemanticType.QUALITY, SemanticType.ORDERING,
                        SemanticType.OBSERVABLE);
            case "quantity":
                return EnumSet.of(SemanticType.QUANTITY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "quality":
                return EnumSet.of(SemanticType.QUALITY, SemanticType.OBSERVABLE);
            case "ordering":
                return EnumSet.of(SemanticType.ORDERING, SemanticType.TRAIT, SemanticType.ATTRIBUTE,
            ...
            case "energy":
                return EnumSet.of(SemanticType.ENERGY, SemanticType.QUALITY, SemanticType.EXTENSIVE,
            ...
            case "entropy":
                return EnumSet.of(SemanticType.ENTROPY, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "length":
                return EnumSet.of(SemanticType.LENGTH, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "mass":
                return EnumSet.of(SemanticType.MASS, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "volume":
                return EnumSet.of(SemanticType.VOLUME, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "weight":
                return EnumSet.of(SemanticType.WEIGHT, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "magnitude":
                return EnumSet.of(SemanticType.MAGNITUDE, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.SUBJECTIVE, SemanticType.QUANTIFIABLE);
            case "monetary_value":
                return EnumSet.of(SemanticType.MONETARY_VALUE, SemanticType.QUALITY,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "money":
                return EnumSet.of(SemanticType.MONEY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "duration":
                return EnumSet.of(SemanticType.DURATION, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "area":
                return EnumSet.of(SemanticType.AREA, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "presence":
                return EnumSet.of(SemanticType.PRESENCE, SemanticType.QUALITY, SemanticType.OBSERVABLE);
            case "proportion":
                return EnumSet.of(SemanticType.PROPORTION, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "percentage":
                return EnumSet.of(SemanticType.PERCENTAGE, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "uncertainty":
                return EnumSet.of(SemanticType.UNCERTAINTY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "rate":
                EnumSet<SemanticType> ret = EnumSet.of(SemanticType.RATE, SemanticType.QUALITY,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            ...
            case "acceleration":
                return EnumSet.of(SemanticType.ACCELERATION, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "priority":
                return EnumSet.of(SemanticType.PRIORITY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "value":
                return EnumSet.of(SemanticType.VALUE, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "ratio":
                return EnumSet.of(SemanticType.RATIO, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "count":
                return EnumSet.of(SemanticType.NUMEROSITY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "electric-potential":
                return EnumSet.of(SemanticType.ELECTRIC_POTENTIAL, SemanticType.QUALITY,
                        SemanticType.INTENSIVE, SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "charge":
                return EnumSet.of(SemanticType.CHARGE, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "resistance":
                return EnumSet.of(SemanticType.RESISTANCE, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "amount":
                return EnumSet.of(SemanticType.AMOUNT, SemanticType.QUALITY, SemanticType.EXTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "resistivity":
                return EnumSet.of(SemanticType.RESISTIVITY, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "occurrence":
                return EnumSet.of(SemanticType.OCCURRENCE, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "probability":
                return EnumSet.of(SemanticType.PROBABILITY, SemanticType.QUALITY, SemanticType.OBSERVABLE,
                        SemanticType.QUANTIFIABLE);
            case "pressure":
                return EnumSet.of(SemanticType.PRESSURE, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "angle":
                return EnumSet.of(SemanticType.ANGLE, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "velocity":
            ...
            case "distance":
                return EnumSet.of(SemanticType.DISTANCE, SemanticType.QUALITY, SemanticType.INTENSIVE,
                        SemanticType.OBSERVABLE, SemanticType.QUANTIFIABLE);
            case "process":
                return EnumSet.of(SemanticType.PROCESS, SemanticType.DIRECT_OBSERVABLE,
                        SemanticType.OBSERVABLE);
            case "change":
                return EnumSet.of(SemanticType.CHANGE, SemanticType.PROCESS, SemanticType.DIRECT_OBSERVABLE
                        , SemanticType.OBSERVABLE);
            case "changed":
                return EnumSet.of(SemanticType.CHANGED, SemanticType.EVENT, SemanticType.COUNTABLE,
                        SemanticType.DIRECT_OBSERVABLE, SemanticType.OBSERVABLE);
            case "agent":
                return EnumSet.of(SemanticType.AGENT, SemanticType.DIRECT_OBSERVABLE,
                        SemanticType.COUNTABLE, SemanticType.OBSERVABLE);
            case "event":
                return EnumSet.of(SemanticType.EVENT, SemanticType.DIRECT_OBSERVABLE,
                        SemanticType.COUNTABLE, SemanticType.OBSERVABLE);
            case "relationship":
                return EnumSet.of(SemanticType.RELATIONSHIP, SemanticType.UNIDIRECTIONAL,
                        SemanticType.DIRECT_OBSERVABLE, SemanticType.COUNTABLE, SemanticType.OBSERVABLE);
            case "bond":
                return EnumSet.of(SemanticType.RELATIONSHIP, SemanticType.BIDIRECTIONAL,
                        SemanticType.DIRECT_OBSERVABLE, SemanticType.COUNTABLE, SemanticType.OBSERVABLE);
            case "configuration":
