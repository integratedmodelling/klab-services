...
public enum UnarySemanticOperator {
  NOT(new SemanticType[] {SemanticType.DENIABLE}, SemanticType.PREDICATE, "not"),
  PRESENCE(
      new SemanticType[] {SemanticType.COUNTABLE}, SemanticType.QUALITY, "presence of"), // FIXME
  // does not account for the different operands
  PROPORTION(
      new SemanticType[] {SemanticType.PREDICATE, SemanticType.QUANTIFIABLE},
  ...
  VALUE(
      new SemanticType[] {SemanticType.OBSERVABLE, SemanticType.CONFIGURATION},
      SemanticType.QUALITY,
      "value of",
      "over"),
  MONETARY_VALUE(
  ...
  TYPE(new SemanticType[] {SemanticType.PREDICATE}, SemanticType.QUALITY, "type of");
  ...
  public static Set<SemanticType> getType(String string, Collection<SemanticType> original) {
    ...
    switch (id) {
      ...
      case "attribute":
        return EnumSet.of(SemanticType.ATTRIBUTE, SemanticType.PREDICATE);
      case "type":
        return EnumSet.of(SemanticType.CLASS, SemanticType.QUALITY, SemanticType.OBSERVABLE);
      case "identity":
        return EnumSet.of(SemanticType.IDENTITY, SemanticType.PREDICATE);
      case "role":
        return EnumSet.of(SemanticType.ROLE, SemanticType.PREDICATE);
      case "realm":
        return EnumSet.of(SemanticType.REALM, SemanticType.PREDICATE);
      case "domain":
      ...
      case "uncertainty":
        return EnumSet.of(
            ...
            SemanticType.QUANTIFIABLE);
      case "rate":
        EnumSet<SemanticType> ret =
            EnumSet.of(
                SemanticType.RATE,
                SemanticType.QUALITY,
                SemanticType.OBSERVABLE,
                SemanticType.QUANTIFIABLE);
        if (original.contains(SemanticType.EXTENSIVE)
            || original.contains(SemanticType.INTENSIVE)) {
      ...
      case "process":
        return EnumSet.of(
            SemanticType.PROCESS, SemanticType.OBSERVABLE);
      case "change":
        return EnumSet.of(
            SemanticType.CHANGE,
