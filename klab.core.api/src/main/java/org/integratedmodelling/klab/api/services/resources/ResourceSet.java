 ...
 * <p>
 * Each resource lists a URN, its "knowledge class", a version and the URL of the service that
 * provides it. All resource sets must contain at least the service that produced it. If the
 * ResultSet is returned as the response for querying a specific URN or a pattern, the result should
 * contain the resource descriptor(s) in {@link #getResults()}. All other fields contain the needed
