...
public class HistogramImpl implements Histogram {
  ...
  /**
   * Keep the concrete element type in the setter so JSON deserializers can reconstruct bins without
   * requiring polymorphic type metadata for the {@link Bin} interface.
   */
