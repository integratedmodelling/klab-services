 ...
 * #DISALLOWED_TRANSITIONS_PROPERTY}, and {@value #MAX_RESPONSE_HOURS_PROPERTY} keys. Values that
 * contain several items are comma separated. Public review additionally requires the identity
 * data flag {@value #KNOWN_REAL_PERSON_PROPERTY}.
 */
