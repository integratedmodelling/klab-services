...
public interface UserScope extends ReactiveScope {
    ...
    /**
     * Any active sessions that have not expired, including running applications and scripts. They may or may
     * not have contexts available.
     *
     * @return
     */
     ...
     * behaviors: APP, SCRIPT or TESTCASE. Each behavior at this level creates an independent SessionScope.
     * The session created with this method will expire and disappear after termination of the application or
     * script.
     *
     * @param behaviorName
     * @param behaviorType
