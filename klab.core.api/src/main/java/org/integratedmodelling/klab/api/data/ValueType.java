...
/**
 * Types for values supported in literals of the various k.LAB languages. Only
 * k.Actors supports all of these.
 * 
 * @author Ferd
 *
 */
public enum ValueType {
	...
	REGEXP, NUMBER, INTEGER, DOUBLE, BOOLEAN, STRING, CONCEPT, OBSERVABLE, IDENTIFIER, EXPRESSION, LIST, SET, CLASS,
	ANYVALUE, ANYTHING, NODATA, RANGE, MAP, TABLE, TREE, QUANTITY, DATE, TYPE, NUMBERED_PATTERN, URN,
