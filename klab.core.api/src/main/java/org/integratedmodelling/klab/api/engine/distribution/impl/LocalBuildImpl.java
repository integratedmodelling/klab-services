...
//
//    AbstractDistributionObsoleteImpl distribution;
//
//    public LocalBuildImpl(File buildPropertyFile, AbstractDistributionObsoleteImpl distribution, ProductImpl product, ReleaseImpl release) {
//        super(buildPropertyFile, product, release);
//        this.distribution = distribution;
//    }
//
//    @Override
//    public Distribution.Product.Status getStatus() {
