 ...
 * {@link Contextualizable}s that <em>produce</em> knowledge or
 * {@link Artifact} that organize it and make it available for successive
 ...
 * is attributed to Agents, which may be {@link UserIdentity} or the AI in
 * k.LAB (for attribution of tasks and acknowledgements) or {@link Model
 ...
 * <p>
 * Any {@link Resource}s used by models (data or computations) come with
