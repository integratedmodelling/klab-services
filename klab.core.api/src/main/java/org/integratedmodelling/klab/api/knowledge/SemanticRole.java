...
/**
 * Roles of each component of an observable expression, to ease modifications (e.g. in builders) and inspect
 * specific clauses. The conceptual components can be used to selectively remove parts of the observable in
 * observable inspection. The structural components are used to report on admissible tokens during interactive
 * building of observables.
 * <p>
