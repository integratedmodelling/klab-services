...
//
//  public LocalProductImpl(File file, AbstractDistributionObsoleteImpl distribution) {
...
//        var ret =
//            release.get().getBuilds().stream()
//                .filter(b -> b.getVersion().getBuild() == Long.parseLong(launched[1]))
//                .findAny();
//        if (ret.isPresent()) {
//          return ret.get();
//        }
...
//      var release = getReleases().getFirst();
//      if (!release.getBuilds().isEmpty()) {
//        return release.getBuilds().getFirst();
//      }
//    }
//    return null;
//  }
