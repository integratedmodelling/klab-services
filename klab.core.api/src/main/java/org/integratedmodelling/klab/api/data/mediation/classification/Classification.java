...
/**
 * Interface representing a classification mechanism, which organizes objects based on concepts
 * and classifiers. A classification may optionally define numeric or discretized representations
 * for the classified concepts.
 */
public interface Classification extends DataKey, Iterable<Pair<Concept, Classifier>> {

  /**
   * Return the main concept that subsumes all those expressed by the classifiers. In some
   * situations this may be null. In normal situations this will be an abstract concept and subsume
   * all others.
   *
  ...
  /**
   * True if this has been declared and validated as a discretization. Subsumes {@link
   * #isContiguousAndFinite()} == true.
   *
   * @return a boolean.
   */
  ...
  /**
   * Return true if all the intervals are contiguous and the extreme intervals have finite
   * boundaries.
   *
  ...
  /**
   * Return the concept that the passed object classifies to, or null if no classifiers match.
   *
   * @param object a {@link java.lang.Object} object.
   * @param scope context of computation
   * @return a {@link org.integratedmodelling.klab.api.knowledge.Concept} object.
   */
