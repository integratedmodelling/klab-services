...
/**
 * Metadata are a glorified parameter map with all the expected constants and
 * some additional methods. They are shared by all k.LAB syntactic objects and
 * their implementations.
 * <p>
 * Serializes correctly only if with a Jackson object mapper instrumented with
...
public interface Metadata extends Parameters<String> {
	...
	/**
	 * Use the RDFS namespace for labels and comments so that we can directly
	 * interact with OWL2.
	 */
	 ...
	 *         {@link Utils.Notifications#hasErrors(Collection)} to check for
	 *         errors.
	 */
