 ...
 * non-semantic {@link DataArtifact} or {@link ObjectArtifact}, an observed
 * (semantic) {@link Observation} (as produced by most activities in k.LAB) or a
 * {@link KimModel k.IM model description} when the model has been produced by
 * an observation activity, such as a learning model.
 * <p>
 * By implementing {@link java.lang.Iterable}, we also allow Artifacts to
 * represent groups of artifacts (e.g. all the {@link Subject subjects}
 * instantiated by resolving a subject {@link Observable observable}). This
...
public interface Artifact extends Provenance.Node, Iterable<Artifact> {
	...
	/**
	 * All non-semantic artifact types produced, contextualized or validated. Used
	 * in various locations, not all compatible with all values.
	 * 
	...
	enum Type {
		...
		/**
		 * A value codified through a temporal resolution according to
	 ...
	 *
	 * @param concept a {@link org.integratedmodelling.klab.api.knowledge.Concept}
	 *                object.
	 ...
	 *                    object.
	 * @return a {@link org.integratedmodelling.klab.api.provenance.Artifact}
	 *         object.
	 */
