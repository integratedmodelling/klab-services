...
public interface ServiceCall extends Encodeable {
    ...
    /**
     * If the function does not have named parameters, any parameters passed are named like this; if
     * there is more than one parameter they will be grouped into a list returned with this key.
     */
     ...
     * returned.
     * 
     * @return the parameters for the call. See {@link #DEFAULT_PARAMETER_NAME} for naming rules if
     *         no names are given.
     */
    ...
    /**
     * Return any parameter IDs that were passed with a syntax that defines those that can be
     * changed by the user (in k.IM, using the ?= operator).
     * 
     * @return
     */
