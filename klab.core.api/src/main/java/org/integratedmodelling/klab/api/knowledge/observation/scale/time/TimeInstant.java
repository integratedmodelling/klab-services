...
public interface TimeInstant extends Serializable, Comparable<TimeInstant>, Locator {
  ...
  /**
   * True if this time starts at a point correspondent with the beginning of the passed resolution -
   * e.g. if the resolution is Months, return true if the time is the beginning of a month.
   *
   * @param res
   * @return
   */
  ...
  public static TimeInstant create(
      int year, int month, int day, int hour, int minutes, int seconds, int milliseconds) {
