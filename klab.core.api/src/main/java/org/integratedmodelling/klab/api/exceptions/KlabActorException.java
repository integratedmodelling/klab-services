...
/**
 * An unchecked exception reserved for situations that should never happen in a production
 * environment. To be used in k.LAB code instead of Java's IllegalArgumentException for ease of
 * debugging.
 *
