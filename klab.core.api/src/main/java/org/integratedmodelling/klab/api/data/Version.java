 ...
 *
 * <p>TODO the version syntax must accept compatibility modifiers so that it can express a version
 * range or constraint as well as a simple version. This should be used only in plugin manifests and
 * project manifests.
 *
 * <p>TODO consider building klab/build.properties in resources with buildnumber-maven-plugin
 * (already included), then turning this into an enum and read the build number and other parameters
 * in the constructor.
 *
 * @author Ferd
 */
public class Version implements Comparable<Version>, Serializable {
  ...
  @Serial private static final long serialVersionUID = -3054349171116917643L;
  ...
  /**
   * Parses given string as version identifier. All missing parts will be initialized to 0 or empty
   * string. Parsing starts from left side of the string.
   *
  ...
  /**
   * If a URN contains a version segment, split it from it and return the URN and the version
   * separately. If not, return the URN paired with EMPTY_VERSION.
   *
   * @param urn
   * @return
   */
   ...
   * @param modifier build name, <code>null</code> value becomes empty string
   */
   ...
   *
   * <p>A version identifier is considered to be greater than or equal if its major component is
   ...
   *
   * <p>A version identifier is considered to be compatible if its major component equals to the
   ...
   *
   * <p>Two version identifiers are considered to be equivalent if their major and minor components
  ...
  /**
   * Returns the string representation of this version identifier. The result satisfies <code>
   * version.equals(new Version(version.toString()))</code>.
   */
  @Override
