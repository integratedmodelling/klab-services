...
public class KlabInternalErrorException extends KlabException {
  ...
  List<Object> problemObjects = new ArrayList<>();
   ...
   */
  public KlabInternalErrorException(String arg0, Object... problemObjects) {
    super(arg0);
    if (problemObjects != null) {
      this.problemObjects = List.of(problemObjects);
    }
  }

  public List<Object> getProblemObjects() {
    return problemObjects;
  }

  public void setProblemObjects(List<Object> problemObjects) {
