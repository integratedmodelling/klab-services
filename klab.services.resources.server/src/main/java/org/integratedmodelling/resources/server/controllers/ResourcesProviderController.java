...
public class ResourcesProviderController {
  ...
  //      description =
  //          "Retrieve all knowledge included in one or more projects with their versions in
  // dependency order")
  //  @ApiResponses({
  ...
  //      @Parameter(description = "URN of the namespace to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //      @Parameter(description = "URN of the ontology to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //      @Parameter(description = "URN of the document to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //      @Parameter(description = "URN of the behavior to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //  @Operation(summary = "Retrieve resource", description = "Get a k.LAB resource by its URN
  // list")
  //  @ApiResponses({
  ...
  //  @Operation(summary = "Resolve resource", description = "Resolve a k.LAB resource by list of
  // URNs")
  //  @ApiResponses({
  //    @ApiResponse(responseCode = "200", description = "Resource resolved successfully"),
  //    @ApiResponse(responseCode = "404", description = "Resource not found"),
  ...
  //      @Parameter(description = "URN of the adapter to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //      @Parameter(description = "URN of the workspace to retrieve") @PathVariable("urn") String
  // urn,
  //      Principal principal) {
  //    return resourcesServer
  //        .klabService()
  ...
  //  @ApiResponses({
  //    @ApiResponse(responseCode = "200", description = "Concept descriptor retrieved
  // successfully"),
  ...
  //  @Operation(summary = "Retrieve concept", description = "Get a k.LAB concept by its
  // definition")
  //  @ApiResponses({
  ...
  //      case "org.integratedmodelling.klab.api.lang.kactors.KActorsBehavior" ->
