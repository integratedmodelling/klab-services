 ...
 * histogram. This implementation is best for histograms with a large (>256)
 * number of bins. It uses tree data structures to give O(logN) insert
 * performance with regard to the number of bins in the histogram. For
 * histograms with fewer bins, the ArrayBinReservoir class offers faster insert
 * performance.
 */
