    ...
    for (Mediation mediator : mediators) {
      if (mediator.extentSize != null) {
        switch (mediator.extentSize) {
          case SPACE_M:
            val =
                mediator.operation == Operation.MULTIPLY
                    ? val
                        * (getSpace(locator).getStandardizedLength()
                            * (mediator.factor == null ? 1.0 : mediator.factor))
                    : val
                        / (getSpace(locator).getStandardizedLength()
                            * (mediator.factor == null ? 1.0 : mediator.factor));
            break;
          case SPACE_M2:
            val =
                mediator.operation == Operation.MULTIPLY
                    ? val
                        * (getSpace(locator).getStandardizedArea()
                            * (mediator.factor == null ? 1.0 : mediator.factor))
                    : val
                        / (getSpace(locator).getStandardizedArea()
                            * (mediator.factor == null ? 1.0 : mediator.factor));
          ...
          case SPACE_M3:
            val =
                mediator.operation == Operation.MULTIPLY
                    ? val
                        * (getSpace(locator).getStandardizedVolume()
                            * (mediator.factor == null ? 1.0 : mediator.factor))
                    : val
                        / (getSpace(locator).getStandardizedVolume()
                            * (mediator.factor == null ? 1.0 : mediator.factor));
          ...
          case TIME_MS:
            val =
                mediator.operation == Operation.MULTIPLY
                    ? val
                        * (((Time) getTime(locator)).getDimensionSize()
                            * (mediator.factor == null ? 1.0 : mediator.factor))
                    : val
                        / (((Time) getTime(locator)).getDimensionSize()
                            * (mediator.factor == null ? 1.0 : mediator.factor));
