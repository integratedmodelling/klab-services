...
public interface Templates {
  ...
  //          + "    assertions = ()\r\n"
  //          + ")\r\n"
  //          + "// change the concept to the one you want; use a URN optionally (in a separate test
  // project "
  ...
  //          + "    // over space(shape=\"EPSG:4326 POLYGON((33.796 -7.086, 35.946 -7.086, 35.946
  // -9.41, 33"
  //          + ".796 -9.41, 33.796 -7.086))\", grid=\"1 km\")\r\n"
  //          + ";\r\n\n"
  //          + "// add any models here\n";
  //
  //  String kimScriptTemplate =
  //      "worldview __WORLDVIEW__;\r\n"
  //          + "\r\n"
  //          + "@run(\r\n"
