...
/**
 * Generic indexer that holds both the index AND the objects themselves in memory. Don't use for
 * anything very large. Queries return the matching objects directly.
 *
 * @author Ferd
 * @param <T>
 */
