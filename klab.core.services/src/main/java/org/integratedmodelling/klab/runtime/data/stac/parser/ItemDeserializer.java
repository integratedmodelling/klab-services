package org.integratedmodelling.klab.runtime.data.stac.parser;
...
import org.integratedmodelling.klab.runtime.data.stac.model.extensions.Extension;import org.integratedmodelling.klab.runtime.data.stac.model.extensions.ExtensionType;
        ...
        while (iterator.hasNext()) {
            ...
            switch (field) {
                ...
                case "bbox":
                    ...
                    break;
                case "geometry":
                    item.setGeometry(STACGeometry.create(STACGeometryType.valueOf(JsonValueHelper.getString(child, "type"))));
                    STACGeometry geometry = item.getGeometry();
                    if (geometry != null) {
