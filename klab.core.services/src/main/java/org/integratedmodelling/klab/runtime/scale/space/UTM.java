 ...
 * </pre>
 *
 * EPSG code for WGS84 datum seems to be EPSG:32[6/7]xx with xx = UTM zone number (0-padded) and 6 =
 * N, 7 = S.
 *
 * <p>Use Universal Polar Stereographic projection for areas above 84N / below 80S.
 *
