...
//    }
    ...
    private Object[] getParameters(ComponentRegistry.FunctionDescriptor descriptor, ServiceCall call, Scope scope,
...
//                try {
//                    ret.constructor =
//                            ret.implementation.getDeclaredConstructor(getParameterClasses(serviceInfo, 1,
//                                    true));
//                    ret.methodCall = 1;
//                } catch (NoSuchMethodException | SecurityException e) {
//                }
...
//                    try {
//                        ret.constructor =
//                                ret.implementation.getDeclaredConstructor(getParameterClasses(serviceInfo, 2,
//                                        true));
//                        ret.methodCall = 2;
//                    } catch (NoSuchMethodException | SecurityException e) {
//                    }
...
//     * @return
//     */
//    private Class<?>[] getParameterClasses(ServiceInfo serviceInfo, int callMethod, boolean isConstructor) {
//        switch (serviceInfo.getFunctionType()) {
//            case ANNOTATION:
//                break;
//            case FUNCTION:
