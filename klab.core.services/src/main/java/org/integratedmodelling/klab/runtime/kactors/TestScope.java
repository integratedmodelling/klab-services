...
//        Message.create(
//            identity.getId(),
//            Message.MessageClass.UnitTests,
//            Message.MessageType.TestFinished,
...
//    Annotation tann = Utils.Annotations.getAnnotation(action, "test");
//    if (tann != null) {
...
//            identity.getId(),
//            Message.MessageClass.UnitTests,
//            Message.MessageType.TestStarted,
//            ret));
//
...
//            identity.getId(),
//            Message.MessageClass.UnitTests,
//            Message.MessageType.TestCaseFinished,
//            this.testStatistics));
//  }
//
...
//    ret.docSection =
//        this.docSection.getChild("anchor:" + action.getUrn() + "[]" + "Test:  " + action.getUrn());
//    ret.action = action;
//    ret.parent = this;
...
//
//          if (ret.actionStatistics.getDescription() != null
//              && !ret.actionStatistics.getDescription().isEmpty()) {
...
//              "Test completed in "
//                  + TimeDuration.print(
//                      ret.actionStatistics.getEnd() - ret.actionStatistics.getStart())
//                  + ": result is "
...
//          buffer.append(
//              AsciiDocBuilder.listingBlock(action.toString(), "kactors", Option.COLLAPSIBLE));
//
...
//              table.addRow(
//                  assertion.getDescriptor(),
//                  assertion.isSuccess() ? "[lime]#SUCCESS#" : "[red]#FAIL#");
//            }
//            buffer.append("\n" + table.toString());
//          }
//
...
//    ret.docSection =
//        this.docSection.getChild("anchor:" + behavior.getUrn() + "[]" + behavior.getUrn());
//    ret.parent = this;
...
//                  + "# successful, [red]#"
//                  + failed
//                  + "# failed. Total test run time "
//                  + TimeDuration.print(elapsed)
//                  + ".\n");
//
//          return buffer.toString();
//        });
...
//    table.addRow(
//        new Table.Span(2, 1), "**Overall test results**", (totalOk + "/" + (totalOk + totalFail)));
//
//    for (TestStatistics child : this.statistics) {
//
//      table.addRow(
//          new Table.Span(2, 1),
//          "<<" + child.getName() + ", Test case **" + child.getName() + "**>>",
...
//            action.isSkipped()
//                ? "SKIP"
//                : (action.getFailure() == 0 ? "[lime]#SUCCESS#" : "[red]#FAIL#"));
//      }
//    }
//
//    return (totalOk + totalFail)
//        + " tests run in "
//        + TimeDuration.print(end - start)
//        + " ([lime]#"
//        + totalOk
//        + "# succeeded, [red]#"
//        + totalFail
...
//  }
//
//  public void notifyAssertion(
//      Object result, KActorsValue expected, boolean ok, Assertion assertion) {
//
...
//        desc.setDescriptor(
//            org.integratedmodelling.common.utils.Utils.Templates.substitute(
//                assertion.getMetadata().get("success", String.class),
//                "value",
//                result,
//                "expected",
//                expected));
...
//        desc.setDescriptor(
//            org.integratedmodelling.common.utils.Utils.Templates.substitute(
//                assertion.getMetadata().get("fail", String.class),
//                "value",
//                result,
//                "expected",
//                expected));
...
//      desc.setDescriptor(
//          org.integratedmodelling.common.utils.Utils.Strings.abbreviate(
//              org.integratedmodelling.common.utils.Utils.Strings.getFirstLine(assertion.toString()),
//              60));
//    }
//  }
//
