 ...
 * https://github.com/tomnelson/jungrapht-visualization/tree/master
 * 
 * @author Ferd
 *
 */
public class Graphs {
    ...
    // show(((KimLoader) Resources.INSTANCE.getLoader()).getDependencyGraph(), "Dependencies",
    // DefaultEdge.class);
    // }
    ...
    public static void show(ResolutionGraph resolution) {
