...
public class Application {
    ...
    @Command(name = "cmd", mixinStandardHelpOptions = true, version = "1.0", description = {
            ...
            " (Note that enum values also get completed.)"}, subcommands = {Nested.class, CommandLine.HelpCommand.class})
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // MyCustomFactory customFactory = createCustomFactory(); // your application custom
            // factory
            // PicocliCommandsFactory factory = new PicocliCommandsFactory(customFactory); // chain
            // the factories
