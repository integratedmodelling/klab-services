...
//					service.resolveNamespace(model.getResourceUrn(), Engine.INSTANCE.getCurrentContext
//					(false));
//					out.println(Utils.Strings.indent(service.resolveModel(model.getResourceUrn(), Engine
