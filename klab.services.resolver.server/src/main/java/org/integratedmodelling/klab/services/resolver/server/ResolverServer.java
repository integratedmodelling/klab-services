...
public class ResolverServer extends ServiceNetworkedInstance<ResolverService> {
  ...
  protected KlabService.Type serviceType() {
    return KlabService.Type.RESOLVER;
  }
  ...
  @Override
  protected ResolverService createPrimaryService(
  ...
  public static void main(String[] args) {
    ServiceNetworkedInstance.start(
        ResolverServer.class, ServiceStartupOptions.create(KlabService.Type.RESOLVER, args));
  }
}
