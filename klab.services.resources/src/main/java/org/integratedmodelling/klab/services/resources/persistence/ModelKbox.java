...
public class ModelKbox extends ObservableKbox {
                ...
                public String serialize(ModelReference model, long primaryKey, long foreignKey) {
                    ...
                    String ret = "INSERT INTO model VALUES (" + primaryKey + ", " + "'" + cn(model.getServerId()) + "', " + "'"
                            ...
                            + (model.getShape() == null
                                    ...
                                    : ((ShapeImpl) model.getShape()).standardizedGeometry().toString())
    ...
    public Collection<ModelReference> query(Observable observable, ContextScope scope) throws KlabException {
        ...
        // Prioritizer<ModelReference> prioritizer = Resolver.getPrioritizer(resolutionScope);
        ...
        // resolutionScope.getMonitor().debug("Model for " + observable + " was preset at
        // resolution");
        // return ret;
        // }
        // }
    ...
    public List<ModelReference> queryModels(Observable observable, ContextScope context) {
        ...
        resourceService.scope().info("model query for " + observable.getDescriptionType() + " of " + observable + " found "
                + (ret.size() == 1 ? ret.get(0).getName() : (ret.size() + " models")));

        return ret;
    }

    // private boolean isAuthorized(ModelReference model, IObservable observable, Set<String>
    // userPermissions,
    ...
    private String spaceQuery(Space space) {
        ...
        String spacequery = "model.space && '" + ((ShapeImpl) space.getGeometricShape()).standardizedGeometry()
