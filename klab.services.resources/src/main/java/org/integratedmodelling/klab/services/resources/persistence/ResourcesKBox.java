...
/**
 * Nitrite-based noSQL embedded storage for observables, resources, models and permissions. The URN is always
 * the primary key. Disk-based with automatic backup. Can navigate semantics and spatial/temporal queries.
 */
public class ResourcesKBox {
    ...
    public ResourcesKBox(Scope scope, ServiceStartupOptions options, ResourcesProvider service) {
        ...
        this.databaseFile = BaseService.getFileInConfigurationSubdirectory(options, "data", "resources.db");
    ...
    /**
     * Store the passed resource with its version. Return true if this was an update of a previously stored
     * resource or this is new.
     *
     * @param resource
     * @return
     */
