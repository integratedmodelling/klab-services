...
public class CoreLibrary {
    ...
    public static class Resources {
        ...
        // TODO
        @KlabFunction(version = Version.CURRENT, name = Klab.StandardLibrary.KlabCore.URN_RESOLVER, dataflowLabel =
                "Resource", description = "Contextualize a quality resource to obtain data", parameters = {
        ...
        @KlabFunction(version = Version.CURRENT, name = Klab.StandardLibrary.KlabCore.LUT_RESOLVER, dataflowLabel =
                "Lookup table", description = "Compute outputs by looking up dependency values in a table",
                      parameters = {
                @Argument(name = "urn", description = "The URN of table to use", type = Artifact.Type.TEXT)}, type =
                              Artifact.Type.VALUE)
        ...
        @KlabFunction(version = Version.CURRENT, name = Klab.StandardLibrary.KlabCore.URN_INSTANTIATOR,
                      dataflowLabel = "Resource", description = "Contextualize a Type.OBJECT resource to obtain " +
                "objects", parameters = {
                @Argument(name = "urn", description = "The URN of the resource to contextualize", type =
                        Artifact.Type.TEXT),
                @Argument(name = "whole", description = "Cut the spatial extent of the resulting object instead of " +
    ...
    public static class Mediators {
        ...
        public static double convertRange(double original, NumericRange originalUnit, NumericRange targetUnit) {
            return 0;
        }
    }
