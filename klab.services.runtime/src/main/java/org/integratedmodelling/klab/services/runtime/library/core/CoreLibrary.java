...
public class CoreLibrary {
	...
	// TODO
	@KlabPrototype(version = Version.CURRENT, name = "urn.resolver", dataflowLabel = "Resource", description = "Contextualize a quality resource to obtain data", parameters = {
	...
	@KlabPrototype(version = Version.CURRENT, name = "lut.resolver", dataflowLabel = "Lookup table", description = "Compute outputs by looking up dependency values in a table", parameters = {
	...
	@KlabPrototype(version = Version.CURRENT, name = "urn.instantiator", dataflowLabel = "Resource", description = "Contextualize a Type.OBJECT resource to obtain objects", parameters = {
