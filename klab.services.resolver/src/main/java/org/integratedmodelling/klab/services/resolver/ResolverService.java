...
public class ResolverService extends BaseService implements Resolver {
    ...
    //
    //        // observation may have been resolved already. Also it could be being resolved from upstream,
    //        and
    ...
    //     create a
    //     * resolution graph; this is done when resolving a model, which creates a graph and merges it
    //     with the
    ...
    //    /**
    //     * If the runtime contains the observation, return it (in resolved or unresolved status but with
    //     a valid
    //     * ID). Otherwise create one in the geometry that the scope implies, with the unresolved ID, and
    //     return it
    ...
    //
    //        if (ret.isEmpty()) {
    //            throw new KlabInternalErrorException("Observation of " + observable.getUrn() + " couldn't
    //            be " +
    //                    "instantiated");
    //        }
    //
    ...
    //
    //                    /*
    //                    Find models and compile them in, merge resolutions until satisfied. We pass the
    //                    scale
    ...
    //                    }
    //
    //                    scope = scope.withResolutionConstraints(constraints.toArray
    //                    (ResolutionConstraint[]::new));
    //
    ...
    //                        resolution.merge(model, coverage, operation.getObservable(), ResolutionType
    //                        .DIRECT);
    //                        if (coverage.isRelevant()) {
    //                            // merge the resolution with the parent resolution
    ...
    //        return ret;
    //
    //        //        ResolutionImpl ret = new ResolutionImpl(strategy.getOriginalObservable(), scale,
    //        scope,
    //        //        parent);
    //        //
    //        //        for (Pair<ObservationStrategyObsolete.Operation, ObservationStrategyObsolete
    //        .Arguments>
    //        //        operation :
    //        //                strategy) {
    ...
    //        //                        coverage = coverage.merge(resolution.getCoverage(),
    ...
    //     * @return
    //     */
    //    private ResolutionImpl resolveModel(Model model, Resolvable observable, Scale scale, ContextScope
    //    scope,
    //                                        ResolutionImpl parent) {
    //
