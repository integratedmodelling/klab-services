...
//
//                PanelLocation panelLocation = Utils.valueOf(Utils.Strings.capitalize(annotation.getName()), PanelLocation.class);
//
...
//        ret.setDescription(Utils.Strings.pack(scope.localize(behavior.getStatement().getDescription())));
...
//            IAnnotation menu = Utils.Annotations.getAnnotation(action, "menu");
//            if (menu != null) {
