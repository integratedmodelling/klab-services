...
//import org.integratedmodelling.kactors.api.KActorsBehavior;
//import org.integratedmodelling.kactors.api.KActorsStatement;
//import org.integratedmodelling.kactors.api.KActorsValue;
...
//        }
//
//        public MatchActions(IBehavior behavior, KActorsScope scope) {
//            this.scope = scope;
...
//
//                        if (initScope.getScope().isInterrupted() || initScope.getScope().hasErrors()) {
//                            /*
...
//                            }
//
//                            initScope.getScope().warn("Initialization failed: skipping rest of behavior");
//
//                            return;
//                        }
//                    }
...
//    }
//
//    protected void run(IBehavior.Action action, IBehavior behavior, KActorsScope scope) {
//
...
//    }
//
//    private boolean execute(KActorsStatement code, IBehavior behavior, KActorsScope scope) {
//
...
//                actions.matches.add(
//                        new Pair<Match, KActorsStatement>(new Match(adesc.getFirst(), adesc.getThird()), adesc.getSecond()));
//            }
...
//    }
//
//    private void executeFor(For code, IBehavior behavior, KActorsScope scope) {
...
//
//    @SuppressWarnings("unchecked")
//    private void executeCall(Call code, IBehavior behavior, KActorsScope scope) {
//
