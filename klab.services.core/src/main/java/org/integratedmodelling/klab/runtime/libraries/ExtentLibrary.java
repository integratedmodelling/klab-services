...
public class ExtentLibrary {
	...
	@KlabPrototype(name = "space", description = "Create spatial extents of all supported types", type = Type.SPATIALEXTENT, version = Version.CURRENT, parameters = {
...
//		}
	...
	@KlabPrototype(name = "time", description = "Create temporal extents of all supported types", type = Type.TEMPORALEXTENT, version = Version.CURRENT, parameters = {
			@Argument(name = "grid", type = { Type.QUANTITY,
	...
	@KlabPrototype(name = "geometry", description = "Create a scale based on a geometry or URN specification", type = Type.GEOMETRY, version = Version.CURRENT, parameters = {
    ...
    public static double parseResolution(Object spec) {
        ...
        Unit uu = Services.INSTANCE.getService(UnitService.class).getUnit(pd.getSecond());
        Unit mm = Services.INSTANCE.getService(UnitService.class).meters();
