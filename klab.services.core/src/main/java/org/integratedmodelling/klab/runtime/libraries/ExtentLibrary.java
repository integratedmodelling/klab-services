...
public class ExtentLibrary {
	...
	@KlabFunction(name = Klab.StandardLibrary.Extents.TIME, description = "Create temporal extents of all supported types", type = Type.TEMPORALEXTENT, version = Version.CURRENT, parameters = {
			@Argument(name = "grid", type = { Type.QUANTITY,
