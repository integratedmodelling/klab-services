...
public class ReasonerController {
  ...
  @Operation(
      summary = "Compute observation strategies",
  ...
  @Operation(
      summary = "Compute identification strategy",
      description =
  ...
  public @ResponseBody IdentificationStrategy inferIdentificationStrategy(
    ...
    if (principal instanceof EngineAuthorization authorization) {
      ...
      return reasoner
          .klabService()
          .computeIdentificationStrategies(request.getObservable(), contextScope);
    }
    throw new KlabInternalErrorException("Unexpected implementation of request authorization");
  }
  ...
  public @ResponseBody Observable resolveObservable(
      @Parameter(description = "Observable definition") @RequestBody String definition) {
   ...
   */
  @Operation(
      summary = "Check if one concept subsumes another",
   ...
   */
  @Operation(
      summary = "Check if concepts match",
   ...
   */
  @Operation(
      summary = "Get concept operands",
      description = "Retrieves the operands of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Operands retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.OPERANDS)
  public @ResponseBody Collection<Concept> operands(
   ...
   */
  @Operation(
      summary = "Get concept children",
      description = "Retrieves the direct children of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Children retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.CHILDREN)
  public @ResponseBody Collection<Concept> children(
      @Parameter(description = "Target concept") @RequestBody Concept target) {
   ...
   */
  @Operation(
      summary = "Get concept parents",
      description = "Retrieves the direct parents of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Parents retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.PARENTS)
  public @ResponseBody Collection<Concept> parents(
      @Parameter(description = "Target concept") @RequestBody Concept target) {
   ...
   */
  @Operation(
      summary = "Get concept parent",
      description = "Retrieves the direct parent of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Parent retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.PARENT)
  public @ResponseBody Concept parent(
      @Parameter(description = "Target concept") @RequestBody Concept c) {
   ...
   */
  @Operation(
      summary = "Get all concept children",
  ...
  public @ResponseBody Collection<Concept> allChildren(
      @Parameter(description = "Target concept") @RequestBody Concept target) {
   ...
   */
  @Operation(
      summary = "Get all concept parents",
  ...
  public @ResponseBody Collection<Concept> allParents(
      @Parameter(description = "Target concept") @RequestBody Concept target) {
   ...
   */
  @Operation(
      summary = "Get concept closure",
      description = "Retrieves the closure (all related concepts) of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Closure retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.CLOSURE)
  public @ResponseBody Collection<Concept> closure(
      @Parameter(description = "Target concept") @RequestBody Concept target) {
  ...
  public @ResponseBody Concept coreObservable(
      @Parameter(description = "Target concept") @RequestBody Concept first) {
    return reasoner.klabService().coreObservable(first);
  }

  /** Split operators from a concept */
  @Operation(
      summary = "Split operators",
      description = "Splits operators from the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Operators split successfully")})
  ...
  @Operation(
      summary = "Get concept roles",
      description = "Retrieves the roles of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Roles retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.ROLES)
  public @ResponseBody Collection<Concept> roles(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct roles only")
  ...
  @Operation(
      summary = "Check if concept has role",
  ...
  public @ResponseBody Concept inherent(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct inherent only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  public @ResponseBody Concept goal(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct goal only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  public Concept causant(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct causant only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  public Concept caused(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct caused only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  public Concept adjacent(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct adjacent only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  @Operation(
      summary = "Get compresent concept",
      description = "Retrieves the compresent concept of the specified concept")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Compresent concept retrieved successfully")
      })
  @PostMapping(ServicesAPI.REASONER.COMPRESENT)
  public Concept compresent(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct compresent only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  @Operation(
      summary = "Get concept traits",
      description = "Retrieves the traits of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Traits retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.TRAITS)
  public Collection<Concept> traits(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct traits only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  @Operation(
      summary = "Get concept identities",
  ...
  public Collection<Concept> identities(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct identities only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  public Collection<Concept> attributes(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct attributes only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  @Operation(
      summary = "Get concept realms",
      description = "Retrieves the realms of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Realms retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.REALMS)
  public Collection<Concept> realms(
      @Parameter(description = "Target concept") @RequestBody Concept concept,
      @Parameter(description = "Whether to get direct realms only")
          @RequestParam(name = "direct", defaultValue = "false")
          boolean direct) {
    return direct
  ...
  @Operation(
      summary = "Check if concept is satisfiable",
      description = "Determines if the specified concept is satisfiable")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Satisfiability check completed successfully")
      })
  ...
  @Operation(
      summary = "Get concept domain",
      description = "Retrieves the semantic domain of the specified concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Domain retrieved successfully")})
  @PostMapping(ServicesAPI.REASONER.DOMAIN)
  public Semantics domain(
      @Parameter(description = "Target concept") @RequestBody Concept conceptImpl) {
    return reasoner.klabService().domain(conceptImpl);
  }

  @Operation(
      summary = "Get applicable observables",
      description = "Retrieves all observables that are applicable to the specified concept")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Applicable observables retrieved successfully")
      })
  @PostMapping(ServicesAPI.REASONER.APPLICABLE)
  public Collection<Concept> applicableObservables(
      @Parameter(description = "Target concept") @RequestBody Concept main) {
    return reasoner.klabService().applicableObservables(main);
  }

  @Operation(
      summary = "Get described type",
  ...
  public Concept describedType(
      @Parameter(description = "Target concept") @RequestBody Concept concept) {
    return reasoner.klabService().describedType(concept);
  }

  @Operation(
      summary = "Check if concepts are compatible",
  ...
  @Operation(
      summary = "Check if concepts are contextually compatible",
      description = "Determines if two concepts are compatible in the context of a third concept")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Contextual compatibility check completed successfully")
      })
  ...
  @Operation(
      summary = "Check if concept is occurrent",
  ...
  public boolean occurrent(
      @Parameter(description = "Target concept") @RequestBody Concept concept) {
    return reasoner.klabService().occurrent(concept);
  }

  @Operation(
      summary = "Get least general common concept",
      description = "Retrieves the least general concept that is common to all input concepts")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Least general common concept retrieved successfully")
      })
  @PostMapping(ServicesAPI.REASONER.LGC)
  public Concept leastGeneralCommon(
      @Parameter(description = "Collection of concepts") @RequestBody Collection<Concept> cc) {
    return reasoner.klabService().leastGeneralCommon(cc);
  }

  @Operation(
      summary = "Check if concept is affected by another",
  ...
  @Operation(
      summary = "Check if concept is created by another",
  ...
  @Operation(
      summary = "Get affected or created concepts",
      description = "Retrieves all concepts that are affected or created by the specified concept")
  @ApiResponses(
      value = {
        @ApiResponse(
            responseCode = "200",
            description = "Affected or created concepts retrieved successfully")
      })
  ...
  public Collection<Concept> affected(
      @Parameter(description = "Target concept") @RequestBody Concept semantics) {
    return reasoner.klabService().affected(semantics);
  }

  @Operation(
      summary = "Get created concepts",
  ...
  public Collection<Concept> created(
      @Parameter(description = "Target concept") @RequestBody Concept semantics) {
    return reasoner.klabService().created(semantics);
  }

  @Operation(
      summary = "Get roles for concept",
      description =
          "Retrieves all roles for the specified concept, optionally in context of another concept")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Roles retrieved successfully")})
  ...
  @Operation(
      summary = "Get implied role",
      description =
          "Retrieves the implied role for the specified concept, optionally in context of another concept")
  @ApiResponses(
      value = {
  ...
  public @ResponseBody Collection<Concept> impliedRoles(
      ...
      @Parameter(description = "Whether to include relationship endpoints")
