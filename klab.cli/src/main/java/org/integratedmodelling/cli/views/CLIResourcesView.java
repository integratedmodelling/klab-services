...
@CommandLine.Command(
    ...
    description = {"Commands to find, list, access and manipulate resources.", ""},
    subcommands = {
...
public class CLIResourcesView extends CLIView implements ResourcesNavigator {
  ...
  public static class Rights implements Runnable {
    ...
    @CommandLine.Option(
        ...
        description = {
          "Comma" + "-separated list of groups to set",
          "Use a +/- sign in " + "front to define access type (+ is default)"
        })
    ...
    @CommandLine.Option(
        ...
        defaultValue = CommandLine.Parameters.NULL_VALUE,
        description = {
          "Comma" + "-separated list of users to set",
          "Use a +/- sign in " + "front to define access type (+ is default)"
        })
  ...
  @CommandLine.Command(
      ...
      mixinStandardHelpOptions = true,
      version = Version.CURRENT,
      description = {"List and describe local or remote resources.", ""},
      subcommands = {})
  public static class List implements Runnable {
    ...
    @CommandLine.Option(
        names = {"-v", "--verbose"},
        defaultValue = "false",
        description = {"List projects in each " + "workspace"},
        required = false)
    private boolean verbose;

    @CommandLine.Parameters(
        description = "A query with wildcards. If not passed, all matches are " + "returned.",
  ...
  //    @CommandLine.Command(name = "import", mixinStandardHelpOptions = true, version =
  // Version.CURRENT,
  //                         description = {
  ...
  //
  //        @CommandLine.Option(names = {"-s", "--service"}, defaultValue = "local" /* TODO
  // initialize at
  //         null */,
  ...
  //                    }
  //
  //                } else if ("jar".equals(Utils.Files.getFileExtension(sourceFile)) ||
  // "zip".equals
  ...
  //                        }
  //                    } else {
  //                        throw new KlabIllegalStateException("Cannot perform admin operations on
  // this " +
  //                                "service");
  //                    }
  //                }
  ...
  @CommandLine.Command(
      ...
      subcommands = {CLIResourcesView.Project.Remove.class})
  public static class Project implements Runnable {
    ...
    @CommandLine.Option(
        names = {"-v", "--verbose"},
        defaultValue = "false",
        description = {"List project " + "contents " + "and " + "metadata"},
        required = false)
    private boolean verbose;
    ...
    //        @CommandLine.Command(name = "add", mixinStandardHelpOptions = true, version =
    // Version.CURRENT,
    //                             description = {
    //                                     "Add a new project to the scope of this service.", ""},
    // subcommands = {})
    //        public static class Add implements Runnable {
    //
    //            @CommandLine.Option(names = {"-s", "--service"}, defaultValue = "local",
    // description = {
    //                    "Resource service " +
    //                            "to connect" +
    //                            " to"},
    ...
    //            private String service;
    //
    //            @CommandLine.Option(names = {"-w", "--workspace"}, defaultValue = "local",
    // description = {
    //                    "Workspace for " +
    //                            "the " +
    //                            "imported" +
    ...
    //
    //            @CommandLine.Option(names = {"-f", "--force"}, defaultValue = "false", description
    // = {"Force reimport of an" +
    //
    //            " existing " +
    //
    //            "project"},
    ...
    //
    //                /*
    //                TODO select the workspace if the passed value isn't null - remove the "local"
    // default and
    ...
    //
    //                //                try {
    //                //                    var url = new File(projectUrl).isDirectory() ? new
    // File(projectUrl)
    //                //                    .toURI().toURL() :
    //                //                              new URI(projectUrl).toURL();
    //                //                    var service = KlabCLI.INSTANCE.service(this.service,
    // ResourcesService
    //                //                    .class);
    //                //                    if (service instanceof ResourcesService.Admin admin) {
    //                //                        if (admin.importProject(workspace, url.toString(),
    // false).isEmpty
    //                //                        ()) {
    //                //                            System.out.println("project " + projectUrl + "
    // was present or
    //                //                            in error, not " + "added");
    //                //                        } else {
    //                //                            System.out.println("project " + projectUrl + "
    ...
    @CommandLine.Command(
        ...
        mixinStandardHelpOptions = true,
        version = Version.CURRENT,
        description = {"Remove a project from this service.", ""},
        subcommands = {})
    public static class Remove implements Runnable {
      ...
      @CommandLine.Parameters private String project;
  ...
  @CommandLine.Command(
      ...
      mixinStandardHelpOptions = true,
      version = Version.CURRENT,
      description = {"Components operations", ""},
      subcommands = {
  ...
  public static class Components implements Runnable {
    ...
    @CommandLine.Command(
        ...
        version = Version.CURRENT,
        description = {
          "Check for updates in a resource's original repository and optionally " + "load it.",
          ""
        },
        subcommands = {})
    public static class Add implements Runnable {
      ...
      @CommandLine.Parameters String componentUrl;
    ...
    @CommandLine.Command(
        ...
        mixinStandardHelpOptions = true,
        version = Version.CURRENT,
        description = {"Remove a component from a service.", ""},
        subcommands = {})
    public static class Remove implements Runnable {
      ...
      @CommandLine.Parameters String componentName;
  ...
  public static class Workspace {
    ...
    @CommandLine.Command(
        ...
        mixinStandardHelpOptions = true,
        version = Version.CURRENT,
        description = {"List and describe local workspaces.", ""},
        subcommands = {})
    public static class List implements Runnable {
    ...
    @CommandLine.Command(
        ...
        mixinStandardHelpOptions = true,
        version = Version.CURRENT,
        description = {"Remove a workspace from this service.", ""},
        subcommands = {})
    public static class Remove implements Runnable {
      ...
      @CommandLine.Parameters private String workspace;
