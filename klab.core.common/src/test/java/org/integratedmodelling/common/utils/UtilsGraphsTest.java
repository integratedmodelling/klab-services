...
public class UtilsGraphsTest {
    ...
    void testTwoNodesWithNonRootCommonAncestor() {
        ...
        List<List<String>> paths = Utils.Graphs.findPathsToCommonAncestor(nodes, (Graph<String, Object>) null, parentFinder(parent));
    ...
    void testEmptyInputReturnsEmptyList() {
        List<List<String>> paths = Utils.Graphs.findPathsToCommonAncestor(Collections.emptyList(), (Graph<String, Object>) null, x -> null);
        assertNotNull(paths);
    ...
    void testNullParentFinderThrows() {
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () ->
                Utils.Graphs.findPathsToCommonAncestor(List.of("A"), (Graph<String, Object>) null, null)
        );
