...
public class ServiceReference {
    ...
    //	public ServiceReference(INodeIdentity node) {
    ...
    public String toString() {
        return "NodeReference [id=" + id + ", permissions=" + permissions + ", partner=" + partner + ", " +
                "urls=" + urls
     ...
     * authenticated user. There should be only one primary service per category. Legacy nodes cannot be
     * primary.
     *
     * @return
     */
