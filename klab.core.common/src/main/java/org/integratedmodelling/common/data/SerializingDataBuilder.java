...
/**
 * The builder to use within the providing resources service to prepare a data package for a remote
 * client to consume. Wraps an Avro-enabled {@link Instance}.
 */
public class SerializingDataBuilder implements Data.Builder {
  ...
  public Data.Builder notification(Notification notification) {
    ...
    nBuilder.setMessage(notification.getMessage());
    nBuilder.setLevel(Level.valueOf(notification.getLevel().name()));
    // TODO more
