...
public class ResolverClient extends BaseServiceClient implements Resolver {
  ...
  //  /**
  //   * When called as a slave from a service, add the sessionId parameter to build a peer scope at
  // the
  //   * remote service side.
  //   *
  //   * @param scope a client scope that should record the ID for future communication. If the ID
  // is
  ...
  //            String.class,
  //            "id",
  //            scope instanceof ServiceSideScope serviceSideScope ? serviceSideScope.getId() :
  // null);
  //
  ...
  //   * When called as a slave from a service, add the sessionId parameter to build a peer scope at
  // the
  //   * remote service side. Send the calling service ID from the scope so that communication can
  // be
