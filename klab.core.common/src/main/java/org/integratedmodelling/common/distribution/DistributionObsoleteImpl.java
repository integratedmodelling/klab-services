...
//import org.integratedmodelling.klab.api.engine.distribution.impl.AbstractDistributionObsoleteImpl;
...
//
///**
// * The main {@link DistributionObsolete} implementation looks up a synchronized, remote distribution in the
...
// */
//public class DistributionObsoleteImpl extends AbstractDistributionObsoleteImpl {
//
...
//  }
//
//  public DistributionObsoleteImpl() {
//    this.workspace =
//        new File(Configuration.INSTANCE.getDataPath() + File.separator + "distribution");
...
//            long totalSize,
//            long downloadSize,
//            Map<DistributionObsolete.FileData, DistributionObsolete.FileTarget> fullList,
//            Map<DistributionObsolete.FileData, DistributionObsolete.FileTarget> downloadList) {
//
//          System.out.println(
//              "Must synchronize "
//                  + downloadList.size()
