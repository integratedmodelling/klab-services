...
public class DistributionModel extends Utils.Properties.Container {
  ...
  public static class BuildModel extends Utils.Properties.Container {
    ...
    private List<Distribution.FileData> files = new ArrayList<>();
    ...
    protected BuildModel(String name, URL url) {
      ...
      try (BufferedReader reader =
        ...
        while ((line = reader.readLine()) != null) {
          ...
          files.add(Distribution.FileData.of(line));
        }
      } catch (IOException e) {
        setEmpty(true);
      }
    ...
    public List<Distribution.FileData> getFiles() {
      return files;
    }

    public void setFiles(List<Distribution.FileData> files) {
      this.files = files;
    }
