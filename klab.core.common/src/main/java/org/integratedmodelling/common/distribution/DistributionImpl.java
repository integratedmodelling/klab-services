...
public class DistributionImpl extends AbstractDistributionImpl {
     ...
     */
    public DistributionImpl(URL url, Scope scope, boolean synchronizeIfIncomplete,
                            boolean synchronizeAnyway) {
    ...
    private void scanForDeletion(File workspace, File file, HashMap<String, String> remote,
                                 ArrayList<File> toRemove) {
